...
from forward_pinn_structure.f_pinn_optimizers import FPINNOptimizers
from forward_pinn_structure.f_pinn_plotting import FPINNPlotting


class ForwardPINN(FPINNOptimizers, FPINNLoss, FPINNPlotting, ABC):
